...
<script>
    async function LoadReports(){
        ...
        $(".sup-list").html("");
        let res = await fetch('/api/<?echo $_SESSION['user']?>/GetActiveReport');
    ...
    async function LoadChat(reportId){
        ...
        let url = '/api/<?echo $_SESSION['user']?>/GetInfoOnReport/' + reportId;
    ...
    async function CloseReport(id){
        let url = '/api/<?echo $_SESSION['user']?>/CloseReport/' + id;
        let res = await fetch(url);

    }
    async function CheckReport(id){
        let url = '/api/<?echo $_SESSION['user']?>/CheckReport/' + id;
        let res = await fetch(url);
        LoadReports();
    }
    async function AddAnswer(repId) {
        ...
        let response = await fetch('/api/<?echo $_SESSION['user']?>/AddAnswer', {
            method: 'POST',
            body: formData
        });
        LoadChat(repId);
