...
<script type="text/javascript">
    async function GetFunction() {
        ...
        `
        let res = await fetch('/api/<?echo $_SESSION['user']?>/GetAllApiFunction');
    ...
    async function OnOfFunction(fid) {
        let url = '/api/<?echo $_SESSION['user']?>/OnOffApiFunction/' + fid;
    ...
    async function UpdateLevel(fid) {
        ...
        let response = await fetch('/api/<?echo $_SESSION['user']?>/UpdateLevelApiFunction', {
            method: 'POST',
            body: formData
        });
    }
    async function OpenModal(id){
        ...
        <div id="myModalFunc" class="func-modal" style="display: block;">
            <div class="func-modal-content">
                ...
                <div class="m-f-body">
                    <input type="text" id="levels" placeholder="Введите новый уровень" style="padding-left= 10px;">
